...
function Section() {
  return (
    ...
    <div className=' bg-black min-h-screen xl:h-fit'>
        ...
        <div className='text-white items-center justify-between p-3 xl:p-6'>
        ...
        <img className='ml-64 w-24 xl:w-56 xl:float-right xl:mr-4 ' src={Dot} alt="dots" />
                                    ...
                                    <div className=' w-28 space-x-0 ml-32 gap-10 xl:w-40 xl:float-right xl:mr-80 '>
                                        ...
                                        <img className='animate-bounce delay-75' src={Puzzle1} alt="second" />
                                        <img className='animate-bounce delay-150 ' src={Puzzle2} alt="third" />
                                        </div>
                                        <div className=' relative flex '>
                                        <img className='animate-bounce animate-pulse' src={Puzzle3} alt="first" />

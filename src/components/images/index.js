export const Col1 = require('./col1/pic 1.png');
export const Col2 = require('./col2/pic 2.png');
export const Col3 = require('./col3/pic 3.png');
export const Col4 = require('./col4/pic 4.png');
export const Col5 = require('./col5/pic 5.png');

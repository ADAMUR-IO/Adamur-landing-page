...
function News() {
  return (
    <div className='bg-black/100 items-center justify-center'>
    {/* <div className='bg-black'> */}
        ...
        <div className='text-center mt-4 gap-20 md:flex lg:flex align-center justify-center items-center pb-4'>
          <input className="placeholder-shown:border-white py-2 px-16 mt-12 h-12 rounded outline-red-500 shadow-sm " placeholder="you@example.com" />

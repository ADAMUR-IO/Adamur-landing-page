  ...
  return (
    <div>
      <div className=' sm:cols-1 md:cols-2 lg:cols-2 lg:flex xl:flex justify-center'>
                ...
                < img className='think item-center xl:h-96  xl:w-screen  xl:ml-24 w-3/4 sm:w-2/4 sm:h-full  ml-12 xl:mt-8 sm:ml-40 sm:mt-5' src={Clara} alt='Inspiration message' />
                ...
                <div>
                  <p className=' font-bold text-lg text-left ml-4 xl:text-5xl xl:ml-16 xl:mt-10 xl:mb-4 sm:ml-16 sm:text-3xl'>Preparing you for Industry delivery</p>
                                ...
                                <div className=' sm:cols-2 md:cols-2 lg:cols-2 ml-6 text-xs text-left mb-4 xl:text-base xl:ml-20 xl:mr-36 xl:mb-14 mr-10 sm:ml-16'>

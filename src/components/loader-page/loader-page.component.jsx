      ...
      <div className='body-container'> {/* start of parent div */}
        ...
        <Logo />
                  ...
                  <p>Product design, UX & UI</p>
                        ...
                        <div> 
                                <a href='https://forms.gle/kHYC6wT26tRu9bF7A'><span title='Good to have you join ADAMUR' className='link-join xl:text-xl xl:mb-8' style={{padding: '3px'}}>Apply for our next cohort</span></a>
                                </div>
                          </div>
                        </div>
                        </div>

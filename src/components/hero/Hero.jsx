...
const Hero = () => {
  ...
  return (
    ...
    {/* <div className="img-container  sm:align-baseline pl-2 mt-[-440px] flex lg:cols-2 md:col-span-1 md:cols-2 gap-2 lg:flex sm:mt-[44px] md:flex  md:ml-4p0 lg:ml-24 m  pt-1">
      <div className="img1-container flex-col ">
        <img src={ Col1 } alt="" />
        <img src={ Col2 } alt="" />
      </div>    
    <div className="img2-container flex-col">
      <img src={ Col3 } alt="" />
      <img src={ Col4 } alt="" />
    </div>  
    <div className="img3-container flex-col">
      <img src={ Col5 } alt="" />
      <img src={ Col6 } alt="" />
      </div>
    <div className="img4-container flex-col">
    <img src={ Col7 } alt="" />
      <img src={ Col8 } alt="" />
</div>
</div> */}

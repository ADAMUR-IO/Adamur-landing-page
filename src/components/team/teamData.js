...
export const teamData = [
    ...
    {
        image: Moses,
        review: 'I would say having the privilege of working under Adamur Tribe has been an excellent learning experience .I`ve also learnt how to work in an agile environment which has enabled me to say focused and productive while working on complex projects .I`ve enjoyed working with the talented and supportive team at Adamur. The work culture is conducive to learning and growing in all aspects of both technology and teamwork',
        name: 'Moses',
        status: 'Backend Developer'
    }

...
function Startup() {
  return (
    <div className='care items-center justify-center'>
...
<p className='inspire  text-center'><strong >Bold</strong>  <span className='xl:p-4'>*</span> <span className='text-c'>Thinkers</span> <span className=' xl:p-4'>*</span> Doers <span className='xl:p-4'>*</span> </p>

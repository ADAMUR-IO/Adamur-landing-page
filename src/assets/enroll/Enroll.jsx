...
<Header />
   <div  style={{marginBottom: '1rem'}}class='enroll bg-black'>
       ...
       <div id="fullName" class="flex flex-row">
                    ...
                    <div id="firstName" class="w-1/2 mr-1 text-white">
                    ...
                    <div id="lastName" class="w-1/2 mr-1 text-white">
                ...
                <input type="email" name="" id="email"
                    class=" bg-white h-16 w-full rounded-md border text-gray border-slate-300 text-sm pl-2 bg-transparent outline-red-500 shadow-sm"/>
      
                  
          <label for="email" class="text-sm">Phone Number</label>
            <input type="phone" name="" id="phone"
              class=" bg-white h-16 w-full rounded-md border text-white border-slate-300 text-sm pl-2 bg-transparent outline-red-500 shadow-sm"/>

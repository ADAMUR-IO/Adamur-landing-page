    ...
    <>
      ...
      <div style={{ backgroundColor: "whitesmoke" }} className="form ">
        <div
          ...
          className="enroll sm: flex align-center justify-center "
        >
          <div
            style={{
              display: "flex",
            ...
            class="enroll bg-white "
          >
            <div className=" pt-1 md:ml-20 lg:ml-4  mt-1 items-center ">
              <p className="text-black lg:text-5xl sm:text-xl md:text-xl font-semibold text-center mt-4">
                Bold * <span className="text-red-600">Thinkers</span> * Doers
              </p>
              <h3 className="text-black sm:text-xl text-center  mt-8">
                Join us for an Extensive Experience
              </h3>
            </div>
            ...
            <div id="fullName" class="grid flex-row text-center gap-4 m-4 p-4">
              <label
                for="fname"
                class="text-sm text-black  lg:text-xl md:text-xl"
              >
                First Name
              </label>
              <input
            ...
            <button
              ...
              className="px-12 py-2 mt-4 flex text-center align-center  text-sm text-black-500 font-semibold rounded-full  hover:text-white hover:bg-gray-500 hover:border-transparent focus
                :outline-none lg:text-xl md:text-xl"
            >
              Enroll
            </button>

            <h6 className="text-white text-center  ">
              Each Cohort has 20 student maximum
            </h6>
          </div>
        </div>
      </div>

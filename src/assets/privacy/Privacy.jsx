	...
	return (
		<div>
			...
			<div className="privacy-policy">
				...
				<p className="content">
					This privacy policy for ATTORN AFRICA LIMITED ("
				...
				<ul className="content">
					<li>
						Download and use our mobile application (HABA), or any other
				...
				<p className="content">
					...
					questions or concerns, please contact us at info@habaapp.com
				</p>
				...
				<p>
					...
					information depending on how you interact with ATTORN AFRICA LIMITED
				...
				<p>
					...
					available here: __________, or by contacting us. We will consider and
					act upon any request in accordance with applicable data protection
					laws.
				</p>
				<p>
					Want to learn more about what ATTORN AFRICA LIMITED does with any
				...
				<ul>
					...
					<li>Location or geographical data</li>
					<li>Business or staff data</li>
				</ul>
				<p>
				...
				<ul>
					<li>
						...
						messages, contacts, and other features. If you wish to change our
				...
				<ul>
					...
					<li>
						...
						We use the data provided to generate financial statements as well as
						provide insight into the how your business data is protected and or
						accessed. We process your information to provide you with the
						requested service.
					</li>
					<li>
				...
				<p>
					...
					please contact us at elvis@kana.africa.
				</p>
				...
				<p>
					...
					with you â€” for example, to send you service-related messages that
				...
				<p>
					<strong>CCPA privacy policy</strong>
				</p>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<td>I. Professional or employment-related informatio</td>
							<td>
						...
						<tr>
							...
							<td>
								...
								an individualâ€™s preferences and characteristics
							</td>
							<td>NO</td>
						</tr>
					</tbody>
				...
				<p>
					You may contact us by email at info@habaapp.com,
					<strong>
				...
				<p>
					ATTORN AFRICA LIMITED has not disclosed or sold any personal
					information to third parties for a business or commercial purpose in
					the preceding twelve (12) months. ATTORN AFRICA LIMITED will not sell
				...
				<p style={{ textDecoration: 'underline' }}>
					Right to Non-Discrimination for the Exercise of a Consumerâ€™s Privacy
					Rights
				</p>
				<p>
				...
				<p>
					...
					info@habaapp.com, or by referring to the contact details at the bottom
				...
				<p>
					...
					our Data Protection Officer (DPO), Jackson Githinji, by email at
					jack@habaapp.com, by phone at 0770148726, or by post to:
				</p>
				<ul style={{ listStyle: 'none' }}>
					<li>ATTORN AFRICA LIMITED</li>
					<li>Jackson Githinji</li>
					<li>10th Floor, ABC Place</li>
					<li>Waiyaki Way, Nairobi</li>
					<li>Nairobi, Kenya 00200</li>
					<li>Kenya</li>
				</ul>
				<h4>
				...
				<p>
					...
					or delete your personal information, please visit: __________. This
					privacy policy was created using Termly's Privacy Policy Generator.
				</p>
			</div>
			<Footer />
		</div>
